...
public class MathHelper {
    ...
    public static double rotLerp(double d0, double d1, double d2) {
        return d1 + d0 * wrapDegrees(d2 - d1);
    }
    ...
    public static Quaternionf rotationAroundAxis(Vector3f vector3f, Quaternionf quaternionf, Quaternionf quaternionf1) {
        float f = vector3f.dot(quaternionf.x, quaternionf.y, quaternionf.z);

        return quaternionf1.set(vector3f.x * f, vector3f.y * f, vector3f.z * f, quaternionf.w).normalize();
    }
