...
public class EntitySlime extends EntityInsentient implements IMonster {
    ...
    private static class PathfinderGoalSlimeRandomJump extends PathfinderGoal {
        ...
        public void tick() {
            ...
            if (controllermove instanceof EntitySlime.ControllerMoveSlime) {
                EntitySlime.ControllerMoveSlime entityslime_controllermoveslime = (EntitySlime.ControllerMoveSlime) controllermove;
