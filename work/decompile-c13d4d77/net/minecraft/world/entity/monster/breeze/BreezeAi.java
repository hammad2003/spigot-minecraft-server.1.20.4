...
public class BreezeAi {
    ...
    protected static BehaviorController<?> makeBrain(BehaviorController<Breeze> behaviorcontroller) {
    ...
    private static void initCoreActivity(BehaviorController<Breeze> behaviorcontroller) {
        behaviorcontroller.addActivity(Activity.CORE, 0, ImmutableList.of(new BehaviorSwim(0.8F), new BehaviorLook(45, 90), new BreezeAi.a(20, 100)));
    }

    private static void initFightActivity(BehaviorController<Breeze> behaviorcontroller) {
        behaviorcontroller.addActivityWithConditions(Activity.FIGHT, ImmutableList.of(Pair.of(0, BehaviorAttackTargetSet.create((breeze) -> {
            return breeze.getBrain().getMemory(MemoryModuleType.NEAREST_ATTACKABLE);
        })), Pair.of(1, BehaviorAttackTargetForget.create()), Pair.of(2, new Shoot()), Pair.of(3, new ShootWhenStuck()), Pair.of(4, new LongJump()), Pair.of(5, new Slide()), Pair.of(6, new BehaviorGateSingle<>(ImmutableList.of(Pair.of(new BehaviorNop(20, 100), 1), Pair.of(BehaviorStrollRandomUnconstrained.stroll(0.6F), 2))))), Set.of());
    }
