...
public class MemoryModuleType<U> {
    ...
    private static <U> MemoryModuleType<U> register(String s, Codec<U> codec) {
        return (MemoryModuleType) IRegistry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, new MinecraftKey(s), new MemoryModuleType<>(Optional.of(codec)));
    }

    private static <U> MemoryModuleType<U> register(String s) {
        return (MemoryModuleType) IRegistry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, new MinecraftKey(s), new MemoryModuleType<>(Optional.empty()));
    }
}
