...
public class Frog extends EntityAnimal implements VariantHolder<FrogVariant> {
    ...
    public void addAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.putString("variant", BuiltInRegistries.FROG_VARIANT.getKey(this.getVariant()).toString());
    }

    @Override
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        super.readAdditionalSaveData(nbttagcompound);
        FrogVariant frogvariant = (FrogVariant) BuiltInRegistries.FROG_VARIANT.get(MinecraftKey.tryParse(nbttagcompound.getString("variant")));
    ...
    protected Vector3f getPassengerAttachmentPoint(Entity entity, EntitySize entitysize, float f) {
        return new Vector3f(0.0F, entitysize.height - 0.125F * f, -0.25F * f);
    }
