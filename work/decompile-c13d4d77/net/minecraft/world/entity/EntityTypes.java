...
public class EntityTypes<T extends Entity> implements FeatureElement, EntityTypeTest<Entity, T> {
    ...
    public static final EntityTypes<Breeze> BREEZE = register("breeze", EntityTypes.Builder.of(Breeze::new, EnumCreatureType.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(10).requiredFeatures(FeatureFlags.UPDATE_1_21));
    public static final EntityTypes<Camel> CAMEL = register("camel", EntityTypes.Builder.of(Camel::new, EnumCreatureType.CREATURE).sized(1.7F, 2.375F).clientTrackingRange(10));
    ...
    public static final EntityTypes<Sniffer> SNIFFER = register("sniffer", EntityTypes.Builder.of(Sniffer::new, EnumCreatureType.CREATURE).sized(1.9F, 1.75F).clientTrackingRange(10));
    ...
    public static final EntityTypes<WindCharge> WIND_CHARGE = register("wind_charge", EntityTypes.Builder.of(WindCharge::new, EnumCreatureType.MISC).sized(0.3125F, 0.3125F).clientTrackingRange(4).updateInterval(10).requiredFeatures(FeatureFlags.UPDATE_1_21));
    ...
    public EntityTypes(EntityTypes.b<T> entitytypes_b, EnumCreatureType enumcreaturetype, boolean flag, boolean flag1, boolean flag2, boolean flag3, ImmutableSet<Block> immutableset, EntitySize entitysize, int i, int j, FeatureFlagSet featureflagset) {
    ...
    @Nullable
    public T create(WorldServer worldserver, @Nullable NBTTagCompound nbttagcompound, @Nullable Consumer<T> consumer, BlockPosition blockposition, EnumMobSpawn enummobspawn, boolean flag, boolean flag1) {
    ...
    public static class Builder<T extends Entity> {
        ...
        public EntityTypes<T> build(String s) {
            ...
            return new EntityTypes<>(this.factory, this.category, this.serialize, this.summon, this.fireImmune, this.canSpawnFarFromPlayer, this.immuneTo, this.dimensions, this.clientTrackingRange, this.updateInterval, this.requiredFeatures);
        }
    }
