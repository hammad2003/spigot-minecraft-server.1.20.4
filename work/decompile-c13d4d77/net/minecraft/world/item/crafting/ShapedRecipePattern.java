...
public record ShapedRecipePattern(int width, int height, NonNullList<RecipeItemStack> ingredients, Optional<ShapedRecipePattern.a> data) {
    ...
    public static ShapedRecipePattern of(Map<Character, RecipeItemStack> map, List<String> list) {
        ...
        return (ShapedRecipePattern) SystemUtils.getOrThrow(unpack(shapedrecipepattern_a), IllegalArgumentException::new);
    }
    ...
    public void toNetwork(PacketDataSerializer packetdataserializer) {
        packetdataserializer.writeVarInt(this.width);
        packetdataserializer.writeVarInt(this.height);
    ...
    public static ShapedRecipePattern fromNetwork(PacketDataSerializer packetdataserializer) {
        int i = packetdataserializer.readVarInt();
        int j = packetdataserializer.readVarInt();
        NonNullList<RecipeItemStack> nonnulllist = NonNullList.withSize(i * j, RecipeItemStack.EMPTY);

        nonnulllist.replaceAll((recipeitemstack) -> {
            return RecipeItemStack.fromNetwork(packetdataserializer);
        });
