...
public class ItemShears extends Item {
    ...
    public boolean mineBlock(ItemStack itemstack, World world, IBlockData iblockdata, BlockPosition blockposition, EntityLiving entityliving) {
        ...
        return !iblockdata.is(TagsBlock.LEAVES) && !iblockdata.is(Blocks.COBWEB) && !iblockdata.is(Blocks.SHORT_GRASS) && !iblockdata.is(Blocks.FERN) && !iblockdata.is(Blocks.DEAD_BUSH) && !iblockdata.is(Blocks.HANGING_ROOTS) && !iblockdata.is(Blocks.VINE) && !iblockdata.is(Blocks.TRIPWIRE) && !iblockdata.is(TagsBlock.WOOL) ? super.mineBlock(itemstack, world, iblockdata, blockposition, entityliving) : true;
    }
