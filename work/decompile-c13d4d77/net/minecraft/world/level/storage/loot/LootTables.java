...
public class LootTables {
    ...
    public static final MinecraftKey ANCIENT_CITY = register("chests/ancient_city");
    public static final MinecraftKey ANCIENT_CITY_ICE_BOX = register("chests/ancient_city_ice_box");
    public static final MinecraftKey RUINED_PORTAL = register("chests/ruined_portal");
    public static final MinecraftKey TRIAL_CHAMBERS_REWARD = register("chests/trial_chambers/reward");
    public static final MinecraftKey TRIAL_CHAMBERS_SUPPLY = register("chests/trial_chambers/supply");
    public static final MinecraftKey TRIAL_CHAMBERS_CORRIDOR = register("chests/trial_chambers/corridor");
    public static final MinecraftKey TRIAL_CHAMBERS_INTERSECTION = register("chests/trial_chambers/intersection");
    public static final MinecraftKey TRIAL_CHAMBERS_INTERSECTION_BARREL = register("chests/trial_chambers/intersection_barrel");
    public static final MinecraftKey TRIAL_CHAMBERS_ENTRANCE = register("chests/trial_chambers/entrance");
    public static final MinecraftKey TRIAL_CHAMBERS_CORRIDOR_DISPENSER = register("dispensers/trial_chambers/corridor");
    public static final MinecraftKey TRIAL_CHAMBERS_CHAMBER_DISPENSER = register("dispensers/trial_chambers/chamber");
    public static final MinecraftKey TRIAL_CHAMBERS_WATER_DISPENSER = register("dispensers/trial_chambers/water");
    public static final MinecraftKey TRIAL_CHAMBERS_CORRIDOR_POT = register("pots/trial_chambers/corridor");
    ...
    public static final MinecraftKey SNIFFER_DIGGING = register("gameplay/sniffer_digging");
    public static final MinecraftKey PIGLIN_BARTERING = register("gameplay/piglin_bartering");
    public static final MinecraftKey SPAWNER_TRIAL_CHAMBER_KEY = register("spawners/trial_chamber/key");
    public static final MinecraftKey SPAWNER_TRIAL_CHAMBER_CONSUMABLES = register("spawners/trial_chamber/consumables");
    ...
    public static final MinecraftKey TRAIL_RUINS_ARCHAEOLOGY_COMMON = register("archaeology/trail_ruins_common");
    public static final MinecraftKey TRAIL_RUINS_ARCHAEOLOGY_RARE = register("archaeology/trail_ruins_rare");
    public static final MinecraftKey OCEAN_RUIN_WARM_ARCHAEOLOGY = register("archaeology/ocean_ruin_warm");
    public static final MinecraftKey OCEAN_RUIN_COLD_ARCHAEOLOGY = register("archaeology/ocean_ruin_cold");
