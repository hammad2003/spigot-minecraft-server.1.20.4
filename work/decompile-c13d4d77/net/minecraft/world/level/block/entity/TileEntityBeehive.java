...
public class TileEntityBeehive extends TileEntity {
    ...
    public void load(NBTTagCompound nbttagcompound) {
        ...
        for (int i = 0; i < nbttaglist.size(); ++i) {
            ...
            TileEntityBeehive.HiveBee tileentitybeehive_hivebee = new TileEntityBeehive.HiveBee(nbttagcompound1.getCompound("EntityData").copy(), nbttagcompound1.getInt("TicksInHive"), nbttagcompound1.getInt("MinOccupationTicks"));
