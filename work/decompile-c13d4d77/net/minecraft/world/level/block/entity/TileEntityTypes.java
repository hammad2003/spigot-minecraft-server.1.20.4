...
public class TileEntityTypes<T extends TileEntity> {
    ...
    public static final TileEntityTypes<TileEntitySign> SIGN = register("sign", TileEntityTypes.b.of(TileEntitySign::new, Blocks.OAK_SIGN, Blocks.SPRUCE_SIGN, Blocks.BIRCH_SIGN, Blocks.ACACIA_SIGN, Blocks.CHERRY_SIGN, Blocks.JUNGLE_SIGN, Blocks.DARK_OAK_SIGN, Blocks.OAK_WALL_SIGN, Blocks.SPRUCE_WALL_SIGN, Blocks.BIRCH_WALL_SIGN, Blocks.ACACIA_WALL_SIGN, Blocks.CHERRY_WALL_SIGN, Blocks.JUNGLE_WALL_SIGN, Blocks.DARK_OAK_WALL_SIGN, Blocks.CRIMSON_SIGN, Blocks.CRIMSON_WALL_SIGN, Blocks.WARPED_SIGN, Blocks.WARPED_WALL_SIGN, Blocks.MANGROVE_SIGN, Blocks.MANGROVE_WALL_SIGN, Blocks.BAMBOO_SIGN, Blocks.BAMBOO_WALL_SIGN));
    public static final TileEntityTypes<HangingSignBlockEntity> HANGING_SIGN = register("hanging_sign", TileEntityTypes.b.of(HangingSignBlockEntity::new, Blocks.OAK_HANGING_SIGN, Blocks.SPRUCE_HANGING_SIGN, Blocks.BIRCH_HANGING_SIGN, Blocks.ACACIA_HANGING_SIGN, Blocks.CHERRY_HANGING_SIGN, Blocks.JUNGLE_HANGING_SIGN, Blocks.DARK_OAK_HANGING_SIGN, Blocks.CRIMSON_HANGING_SIGN, Blocks.WARPED_HANGING_SIGN, Blocks.MANGROVE_HANGING_SIGN, Blocks.BAMBOO_HANGING_SIGN, Blocks.OAK_WALL_HANGING_SIGN, Blocks.SPRUCE_WALL_HANGING_SIGN, Blocks.BIRCH_WALL_HANGING_SIGN, Blocks.ACACIA_WALL_HANGING_SIGN, Blocks.CHERRY_WALL_HANGING_SIGN, Blocks.JUNGLE_WALL_HANGING_SIGN, Blocks.DARK_OAK_WALL_HANGING_SIGN, Blocks.CRIMSON_WALL_HANGING_SIGN, Blocks.WARPED_WALL_HANGING_SIGN, Blocks.MANGROVE_WALL_HANGING_SIGN, Blocks.BAMBOO_WALL_HANGING_SIGN));
    ...
    public static final TileEntityTypes<CalibratedSculkSensorBlockEntity> CALIBRATED_SCULK_SENSOR = register("calibrated_sculk_sensor", TileEntityTypes.b.of(CalibratedSculkSensorBlockEntity::new, Blocks.CALIBRATED_SCULK_SENSOR));
    ...
    public static final TileEntityTypes<ChiseledBookShelfBlockEntity> CHISELED_BOOKSHELF = register("chiseled_bookshelf", TileEntityTypes.b.of(ChiseledBookShelfBlockEntity::new, Blocks.CHISELED_BOOKSHELF));
    public static final TileEntityTypes<BrushableBlockEntity> BRUSHABLE_BLOCK = register("brushable_block", TileEntityTypes.b.of(BrushableBlockEntity::new, Blocks.SUSPICIOUS_SAND, Blocks.SUSPICIOUS_GRAVEL));
    public static final TileEntityTypes<DecoratedPotBlockEntity> DECORATED_POT = register("decorated_pot", TileEntityTypes.b.of(DecoratedPotBlockEntity::new, Blocks.DECORATED_POT));
    public static final TileEntityTypes<CrafterBlockEntity> CRAFTER = register("crafter", TileEntityTypes.b.of(CrafterBlockEntity::new, Blocks.CRAFTER));
    public static final TileEntityTypes<TrialSpawnerBlockEntity> TRIAL_SPAWNER = register("trial_spawner", TileEntityTypes.b.of(TrialSpawnerBlockEntity::new, Blocks.TRIAL_SPAWNER));
    ...
    private static <T extends TileEntity> TileEntityTypes<T> register(String s, TileEntityTypes.b<T> tileentitytypes_b) {
        ...
        return (TileEntityTypes) IRegistry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, s, tileentitytypes_b.build(type));
    }
