...
public class BlockWitherRose extends BlockFlowers {
    ...
    public BlockWitherRose(MobEffectList mobeffectlist, int i, BlockBase.Info blockbase_info) {
        this(makeEffectList(mobeffectlist, i), blockbase_info);
    }

    public BlockWitherRose(List<SuspiciousEffectHolder.a> list, BlockBase.Info blockbase_info) {
