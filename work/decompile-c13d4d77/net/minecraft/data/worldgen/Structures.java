...
public class Structures {
    ...
    public static Structure.c structure(HolderSet<BiomeBase> holderset, Map<EnumCreatureType, StructureSpawnOverride> map, WorldGenStage.Decoration worldgenstage_decoration, TerrainAdjustment terrainadjustment) {
    ...
    public static void bootstrap(BootstapContext<Structure> bootstapcontext) {
        ...
        })), WorldGenStage.Decoration.UNDERGROUND_DECORATION, TerrainAdjustment.BEARD_BOX), holdergetter1.getOrThrow(AncientCityStructurePieces.START), Optional.of(new MinecraftKey("city_anchor")), 7, ConstantHeight.of(VerticalAnchor.absolute(-27)), false, Optional.empty(), 116, List.of()));
        bootstapcontext.register(BuiltinStructures.TRAIL_RUINS, new JigsawStructure(structure(holdergetter.getOrThrow(BiomeTags.HAS_TRAIL_RUINS), Map.of(), WorldGenStage.Decoration.UNDERGROUND_STRUCTURES, TerrainAdjustment.BURY), holdergetter1.getOrThrow(TrailRuinsStructurePools.START), 7, ConstantHeight.of(VerticalAnchor.absolute(-15)), false, HeightMap.Type.WORLD_SURFACE_WG));
    }
}
