...
public class VegetationFeatures {
    ...
    public static void bootstrap(BootstapContext<WorldGenFeatureConfigured<?, ?>> bootstapcontext) {
        ...
        FeatureUtils.register(bootstapcontext, VegetationFeatures.PATCH_TAIGA_GRASS, WorldGenerator.RANDOM_PATCH, grassPatch(new WorldGenFeatureStateProviderWeighted(SimpleWeightedRandomList.builder().add(Blocks.SHORT_GRASS.defaultBlockState(), 1).add(Blocks.FERN.defaultBlockState(), 4)), 32));
        FeatureUtils.register(bootstapcontext, VegetationFeatures.PATCH_GRASS, WorldGenerator.RANDOM_PATCH, grassPatch(WorldGenFeatureStateProvider.simple(Blocks.SHORT_GRASS), 32));
        ...
        FeatureUtils.register(bootstapcontext, VegetationFeatures.SINGLE_PIECE_OF_GRASS, WorldGenerator.SIMPLE_BLOCK, new WorldGenFeatureBlockConfiguration(WorldGenFeatureStateProvider.simple(Blocks.SHORT_GRASS.defaultBlockState())));
