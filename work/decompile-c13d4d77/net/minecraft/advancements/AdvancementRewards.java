...
public record AdvancementRewards(int experience, List<MinecraftKey> loot, List<MinecraftKey> recipes, Optional<CacheableFunction> function) {
    ...
    public void grant(EntityPlayer entityplayer) {
        ...
        while (iterator.hasNext()) {
            ...
            ObjectListIterator objectlistiterator = entityplayer.server.getLootData().getLootTable(minecraftkey).getRandomItems(lootparams).iterator();
    ...
    public static class a {
        ...
        private final Builder<MinecraftKey> loot = ImmutableList.builder();
