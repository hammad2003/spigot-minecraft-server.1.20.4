...
public class CriterionTriggerCuredZombieVillager extends CriterionTriggerAbstract<CriterionTriggerCuredZombieVillager.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<ContextAwarePredicate> zombie, Optional<ContextAwarePredicate> villager) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<CriterionTriggerCuredZombieVillager.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(CriterionTriggerCuredZombieVillager.a::player), ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "zombie").forGetter(CriterionTriggerCuredZombieVillager.a::zombie), ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "villager").forGetter(CriterionTriggerCuredZombieVillager.a::villager)).apply(instance, CriterionTriggerCuredZombieVillager.a::new);
        });
