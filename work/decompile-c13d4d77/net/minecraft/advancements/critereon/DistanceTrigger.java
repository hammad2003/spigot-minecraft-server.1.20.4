...
public class DistanceTrigger extends CriterionTriggerAbstract<DistanceTrigger.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<CriterionConditionLocation> startPosition, Optional<CriterionConditionDistance> distance) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<DistanceTrigger.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(DistanceTrigger.a::player), ExtraCodecs.strictOptionalField(CriterionConditionLocation.CODEC, "start_position").forGetter(DistanceTrigger.a::startPosition), ExtraCodecs.strictOptionalField(CriterionConditionDistance.CODEC, "distance").forGetter(DistanceTrigger.a::distance)).apply(instance, DistanceTrigger.a::new);
        });
