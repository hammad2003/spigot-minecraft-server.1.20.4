...
public class CriterionSlideDownBlock extends CriterionTriggerAbstract<CriterionSlideDownBlock.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<Holder<Block>> block, Optional<CriterionTriggerProperties> state) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<CriterionSlideDownBlock.a> CODEC = ExtraCodecs.validate(RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(CriterionSlideDownBlock.a::player), ExtraCodecs.strictOptionalField(BuiltInRegistries.BLOCK.holderByNameCodec(), "block").forGetter(CriterionSlideDownBlock.a::block), ExtraCodecs.strictOptionalField(CriterionTriggerProperties.CODEC, "state").forGetter(CriterionSlideDownBlock.a::state)).apply(instance, CriterionSlideDownBlock.a::new);
        }), CriterionSlideDownBlock.a::validate);
