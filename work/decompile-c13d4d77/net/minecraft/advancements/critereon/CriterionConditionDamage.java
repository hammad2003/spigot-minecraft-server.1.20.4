...
public record CriterionConditionDamage(CriterionConditionValue.DoubleRange dealtDamage, CriterionConditionValue.DoubleRange takenDamage, Optional<CriterionConditionEntity> sourceEntity, Optional<Boolean> blocked, Optional<CriterionConditionDamageSource> type) {
    ...
    public static final Codec<CriterionConditionDamage> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionValue.DoubleRange.CODEC, "dealt", CriterionConditionValue.DoubleRange.ANY).forGetter(CriterionConditionDamage::dealtDamage), ExtraCodecs.strictOptionalField(CriterionConditionValue.DoubleRange.CODEC, "taken", CriterionConditionValue.DoubleRange.ANY).forGetter(CriterionConditionDamage::takenDamage), ExtraCodecs.strictOptionalField(CriterionConditionEntity.CODEC, "source_entity").forGetter(CriterionConditionDamage::sourceEntity), ExtraCodecs.strictOptionalField(Codec.BOOL, "blocked").forGetter(CriterionConditionDamage::blocked), ExtraCodecs.strictOptionalField(CriterionConditionDamageSource.CODEC, "type").forGetter(CriterionConditionDamage::type)).apply(instance, CriterionConditionDamage::new);
    });
