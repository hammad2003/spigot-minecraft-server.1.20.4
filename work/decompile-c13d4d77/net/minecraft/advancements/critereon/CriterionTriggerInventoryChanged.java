...
public class CriterionTriggerInventoryChanged extends CriterionTriggerAbstract<CriterionTriggerInventoryChanged.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, CriterionTriggerInventoryChanged.a.a slots, List<CriterionConditionItem> items) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<CriterionTriggerInventoryChanged.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(CriterionTriggerInventoryChanged.a::player), ExtraCodecs.strictOptionalField(CriterionTriggerInventoryChanged.a.a.CODEC, "slots", CriterionTriggerInventoryChanged.a.a.ANY).forGetter(CriterionTriggerInventoryChanged.a::slots), ExtraCodecs.strictOptionalField(CriterionConditionItem.CODEC.listOf(), "items", List.of()).forGetter(CriterionTriggerInventoryChanged.a::items)).apply(instance, CriterionTriggerInventoryChanged.a::new);
        });
        ...
        public boolean matches(PlayerInventory playerinventory, ItemStack itemstack, int i, int j, int k) {
            if (!this.slots.matches(i, j, k)) {
                ...
                return !itemstack.isEmpty() && ((CriterionConditionItem) this.items.get(0)).matches(itemstack);
            }
        }
        ...
        public static record a(CriterionConditionValue.IntegerRange occupied, CriterionConditionValue.IntegerRange full, CriterionConditionValue.IntegerRange empty) {
            ...
            public static final Codec<CriterionTriggerInventoryChanged.a.a> CODEC = RecordCodecBuilder.create((instance) -> {
                return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionValue.IntegerRange.CODEC, "occupied", CriterionConditionValue.IntegerRange.ANY).forGetter(CriterionTriggerInventoryChanged.a.a::occupied), ExtraCodecs.strictOptionalField(CriterionConditionValue.IntegerRange.CODEC, "full", CriterionConditionValue.IntegerRange.ANY).forGetter(CriterionTriggerInventoryChanged.a.a::full), ExtraCodecs.strictOptionalField(CriterionConditionValue.IntegerRange.CODEC, "empty", CriterionConditionValue.IntegerRange.ANY).forGetter(CriterionTriggerInventoryChanged.a.a::empty)).apply(instance, CriterionTriggerInventoryChanged.a.a::new);
            });
