...
public class CriterionTriggerBredAnimals extends CriterionTriggerAbstract<CriterionTriggerBredAnimals.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<ContextAwarePredicate> parent, Optional<ContextAwarePredicate> partner, Optional<ContextAwarePredicate> child) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<CriterionTriggerBredAnimals.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(CriterionTriggerBredAnimals.a::player), ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "parent").forGetter(CriterionTriggerBredAnimals.a::parent), ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "partner").forGetter(CriterionTriggerBredAnimals.a::partner), ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "child").forGetter(CriterionTriggerBredAnimals.a::child)).apply(instance, CriterionTriggerBredAnimals.a::new);
        });
