...
public class CriterionTriggerItemDurabilityChanged extends CriterionTriggerAbstract<CriterionTriggerItemDurabilityChanged.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<CriterionConditionItem> item, CriterionConditionValue.IntegerRange durability, CriterionConditionValue.IntegerRange delta) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<CriterionTriggerItemDurabilityChanged.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(CriterionTriggerItemDurabilityChanged.a::player), ExtraCodecs.strictOptionalField(CriterionConditionItem.CODEC, "item").forGetter(CriterionTriggerItemDurabilityChanged.a::item), ExtraCodecs.strictOptionalField(CriterionConditionValue.IntegerRange.CODEC, "durability", CriterionConditionValue.IntegerRange.ANY).forGetter(CriterionTriggerItemDurabilityChanged.a::durability), ExtraCodecs.strictOptionalField(CriterionConditionValue.IntegerRange.CODEC, "delta", CriterionConditionValue.IntegerRange.ANY).forGetter(CriterionTriggerItemDurabilityChanged.a::delta)).apply(instance, CriterionTriggerItemDurabilityChanged.a::new);
        });
