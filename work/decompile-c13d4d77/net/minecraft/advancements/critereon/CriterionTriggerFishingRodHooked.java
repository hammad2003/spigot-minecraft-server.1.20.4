...
public class CriterionTriggerFishingRodHooked extends CriterionTriggerAbstract<CriterionTriggerFishingRodHooked.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<CriterionConditionItem> rod, Optional<ContextAwarePredicate> entity, Optional<CriterionConditionItem> item) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<CriterionTriggerFishingRodHooked.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(CriterionTriggerFishingRodHooked.a::player), ExtraCodecs.strictOptionalField(CriterionConditionItem.CODEC, "rod").forGetter(CriterionTriggerFishingRodHooked.a::rod), ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "entity").forGetter(CriterionTriggerFishingRodHooked.a::entity), ExtraCodecs.strictOptionalField(CriterionConditionItem.CODEC, "item").forGetter(CriterionTriggerFishingRodHooked.a::item)).apply(instance, CriterionTriggerFishingRodHooked.a::new);
        });
