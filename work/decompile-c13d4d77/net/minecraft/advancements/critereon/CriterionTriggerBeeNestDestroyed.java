...
public class CriterionTriggerBeeNestDestroyed extends CriterionTriggerAbstract<CriterionTriggerBeeNestDestroyed.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<Holder<Block>> block, Optional<CriterionConditionItem> item, CriterionConditionValue.IntegerRange beesInside) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<CriterionTriggerBeeNestDestroyed.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(CriterionTriggerBeeNestDestroyed.a::player), ExtraCodecs.strictOptionalField(BuiltInRegistries.BLOCK.holderByNameCodec(), "block").forGetter(CriterionTriggerBeeNestDestroyed.a::block), ExtraCodecs.strictOptionalField(CriterionConditionItem.CODEC, "item").forGetter(CriterionTriggerBeeNestDestroyed.a::item), ExtraCodecs.strictOptionalField(CriterionConditionValue.IntegerRange.CODEC, "num_bees_inside", CriterionConditionValue.IntegerRange.ANY).forGetter(CriterionTriggerBeeNestDestroyed.a::beesInside)).apply(instance, CriterionTriggerBeeNestDestroyed.a::new);
        });
        ...
        public boolean matches(IBlockData iblockdata, ItemStack itemstack, int i) {
            return this.block.isPresent() && !iblockdata.is((Holder) this.block.get()) ? false : (this.item.isPresent() && !((CriterionConditionItem) this.item.get()).matches(itemstack) ? false : this.beesInside.matches(i));
        }
    }
}
