...
public record CriterionConditionDamageSource(List<TagPredicate<DamageType>> tags, Optional<CriterionConditionEntity> directEntity, Optional<CriterionConditionEntity> sourceEntity) {
    ...
    public static final Codec<CriterionConditionDamageSource> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ExtraCodecs.strictOptionalField(TagPredicate.codec(Registries.DAMAGE_TYPE).listOf(), "tags", List.of()).forGetter(CriterionConditionDamageSource::tags), ExtraCodecs.strictOptionalField(CriterionConditionEntity.CODEC, "direct_entity").forGetter(CriterionConditionDamageSource::directEntity), ExtraCodecs.strictOptionalField(CriterionConditionEntity.CODEC, "source_entity").forGetter(CriterionConditionDamageSource::sourceEntity)).apply(instance, CriterionConditionDamageSource::new);
    });
