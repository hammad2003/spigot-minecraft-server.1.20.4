...
public class RecipeCraftedTrigger extends CriterionTriggerAbstract<RecipeCraftedTrigger.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, MinecraftKey recipeId, List<CriterionConditionItem> ingredients) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<RecipeCraftedTrigger.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(RecipeCraftedTrigger.a::player), MinecraftKey.CODEC.fieldOf("recipe_id").forGetter(RecipeCraftedTrigger.a::recipeId), ExtraCodecs.strictOptionalField(CriterionConditionItem.CODEC.listOf(), "ingredients", List.of()).forGetter(RecipeCraftedTrigger.a::ingredients)).apply(instance, RecipeCraftedTrigger.a::new);
        });
