...
public class CriterionTriggerLevitation extends CriterionTriggerAbstract<CriterionTriggerLevitation.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<CriterionConditionDistance> distance, CriterionConditionValue.IntegerRange duration) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<CriterionTriggerLevitation.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(CriterionTriggerLevitation.a::player), ExtraCodecs.strictOptionalField(CriterionConditionDistance.CODEC, "distance").forGetter(CriterionTriggerLevitation.a::distance), ExtraCodecs.strictOptionalField(CriterionConditionValue.IntegerRange.CODEC, "duration", CriterionConditionValue.IntegerRange.ANY).forGetter(CriterionTriggerLevitation.a::duration)).apply(instance, CriterionTriggerLevitation.a::new);
        });
