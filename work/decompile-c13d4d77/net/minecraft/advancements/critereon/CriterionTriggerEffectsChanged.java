...
public class CriterionTriggerEffectsChanged extends CriterionTriggerAbstract<CriterionTriggerEffectsChanged.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<CriterionConditionMobEffect> effects, Optional<ContextAwarePredicate> source) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<CriterionTriggerEffectsChanged.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(CriterionTriggerEffectsChanged.a::player), ExtraCodecs.strictOptionalField(CriterionConditionMobEffect.CODEC, "effects").forGetter(CriterionTriggerEffectsChanged.a::effects), ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "source").forGetter(CriterionTriggerEffectsChanged.a::source)).apply(instance, CriterionTriggerEffectsChanged.a::new);
        });
