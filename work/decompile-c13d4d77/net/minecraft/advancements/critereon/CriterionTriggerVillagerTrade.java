...
public class CriterionTriggerVillagerTrade extends CriterionTriggerAbstract<CriterionTriggerVillagerTrade.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<ContextAwarePredicate> villager, Optional<CriterionConditionItem> item) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<CriterionTriggerVillagerTrade.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(CriterionTriggerVillagerTrade.a::player), ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "villager").forGetter(CriterionTriggerVillagerTrade.a::villager), ExtraCodecs.strictOptionalField(CriterionConditionItem.CODEC, "item").forGetter(CriterionTriggerVillagerTrade.a::item)).apply(instance, CriterionTriggerVillagerTrade.a::new);
        });
