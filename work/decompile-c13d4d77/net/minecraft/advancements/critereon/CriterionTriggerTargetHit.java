...
public class CriterionTriggerTargetHit extends CriterionTriggerAbstract<CriterionTriggerTargetHit.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, CriterionConditionValue.IntegerRange signalStrength, Optional<ContextAwarePredicate> projectile) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<CriterionTriggerTargetHit.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(CriterionTriggerTargetHit.a::player), ExtraCodecs.strictOptionalField(CriterionConditionValue.IntegerRange.CODEC, "signal_strength", CriterionConditionValue.IntegerRange.ANY).forGetter(CriterionTriggerTargetHit.a::signalStrength), ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "projectile").forGetter(CriterionTriggerTargetHit.a::projectile)).apply(instance, CriterionTriggerTargetHit.a::new);
        });
