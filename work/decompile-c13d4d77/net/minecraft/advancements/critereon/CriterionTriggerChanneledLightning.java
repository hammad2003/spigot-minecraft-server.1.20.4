...
public class CriterionTriggerChanneledLightning extends CriterionTriggerAbstract<CriterionTriggerChanneledLightning.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, List<ContextAwarePredicate> victims) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<CriterionTriggerChanneledLightning.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(CriterionTriggerChanneledLightning.a::player), ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC.listOf(), "victims", List.of()).forGetter(CriterionTriggerChanneledLightning.a::victims)).apply(instance, CriterionTriggerChanneledLightning.a::new);
        });
