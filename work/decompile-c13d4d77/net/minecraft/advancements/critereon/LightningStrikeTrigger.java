...
public class LightningStrikeTrigger extends CriterionTriggerAbstract<LightningStrikeTrigger.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<ContextAwarePredicate> lightning, Optional<ContextAwarePredicate> bystander) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<LightningStrikeTrigger.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(LightningStrikeTrigger.a::player), ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "lightning").forGetter(LightningStrikeTrigger.a::lightning), ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "bystander").forGetter(LightningStrikeTrigger.a::bystander)).apply(instance, LightningStrikeTrigger.a::new);
        });
