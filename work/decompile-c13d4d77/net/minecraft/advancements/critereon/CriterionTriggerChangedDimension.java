...
public class CriterionTriggerChangedDimension extends CriterionTriggerAbstract<CriterionTriggerChangedDimension.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<ResourceKey<World>> from, Optional<ResourceKey<World>> to) implements CriterionTriggerAbstract.a {
        ...
        public static final Codec<CriterionTriggerChangedDimension.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.ADVANCEMENT_CODEC, "player").forGetter(CriterionTriggerChangedDimension.a::player), ExtraCodecs.strictOptionalField(ResourceKey.codec(Registries.DIMENSION), "from").forGetter(CriterionTriggerChangedDimension.a::from), ExtraCodecs.strictOptionalField(ResourceKey.codec(Registries.DIMENSION), "to").forGetter(CriterionTriggerChangedDimension.a::to)).apply(instance, CriterionTriggerChangedDimension.a::new);
        });
