...
public class Particles {
    ...
    public static final Particle<ParticleParamBlock> BLOCK = register("block", false, ParticleParamBlock.DESERIALIZER, ParticleParamBlock::codec);
    public static final Particle<ParticleParamBlock> BLOCK_MARKER = register("block_marker", true, ParticleParamBlock.DESERIALIZER, ParticleParamBlock::codec);
    ...
    public static final Particle<ParticleParamRedstone> DUST = register("dust", false, ParticleParamRedstone.DESERIALIZER, (particle) -> {
        return ParticleParamRedstone.CODEC;
    });
    public static final Particle<DustColorTransitionOptions> DUST_COLOR_TRANSITION = register("dust_color_transition", false, DustColorTransitionOptions.DESERIALIZER, (particle) -> {
    ...
    public static final ParticleType GUST_EMITTER = register("gust_emitter", true);
    public static final ParticleType SONIC_BOOM = register("sonic_boom", true);
    public static final Particle<ParticleParamBlock> FALLING_DUST = register("falling_dust", false, ParticleParamBlock.DESERIALIZER, ParticleParamBlock::codec);
    ...
    public static final Particle<SculkChargeParticleOptions> SCULK_CHARGE = register("sculk_charge", true, SculkChargeParticleOptions.DESERIALIZER, (particle) -> {
    ...
    public static final Particle<ParticleParamItem> ITEM = register("item", false, ParticleParamItem.DESERIALIZER, ParticleParamItem::codec);
    public static final Particle<VibrationParticleOption> VIBRATION = register("vibration", true, VibrationParticleOption.DESERIALIZER, (particle) -> {
    ...
    public static final Particle<ShriekParticleOption> SHRIEK = register("shriek", false, ShriekParticleOption.DESERIALIZER, (particle) -> {
    ...
    public static final ParticleType GUST_DUST = register("gust_dust", false);
    public static final ParticleType TRIAL_SPAWNER_DETECTION = register("trial_spawner_detection", true);
    ...
    private static <T extends ParticleParam> Particle<T> register(String s, boolean flag, ParticleParam.a<T> particleparam_a, final Function<Particle<T>, Codec<T>> function) {
        return (Particle) IRegistry.register(BuiltInRegistries.PARTICLE_TYPE, s, new Particle<T>(flag, particleparam_a) {
            @Override
