...
class ReportGameListener implements GameTestHarnessListener {
    ...
    public void testPassed(GameTestHarnessInfo gametestharnessinfo) {
        ...
        if (gametestharnessinfo.rerunUntilFailed()) {
            s = gametestharnessinfo.getTestName();
            reportPassed(gametestharnessinfo, s + " passed! (" + gametestharnessinfo.getRunTime() + "ms). Rerunning until failed.");
            this.rerunTest();
    ...
    private void rerunTest() {
        ...
        gametestharnessinfo.setRerunUntilFailed(this.originalTestInfo.rerunUntilFailed());
        this.testTicker.add(gametestharnessinfo);
        gametestharnessinfo.addListener(this);
        gametestharnessinfo.prepareTestStructure(this.structurePos);
    }
