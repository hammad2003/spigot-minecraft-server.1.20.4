...
public class CommandExecute {
    ...
    private static ArgumentBuilder<CommandListenerWrapper, ?> addConditionals(CommandNode<CommandListenerWrapper> commandnode, LiteralArgumentBuilder<CommandListenerWrapper> literalargumentbuilder, boolean flag, CommandBuildContext commandbuildcontext) {
        ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) literalargumentbuilder.then(net.minecraft.commands.CommandDispatcher.literal("block").then(net.minecraft.commands.CommandDispatcher.argument("pos", ArgumentPosition.blockPos()).then(addConditional(commandnode, net.minecraft.commands.CommandDispatcher.argument("block", ArgumentBlockPredicate.blockPredicate(commandbuildcontext)), flag, (commandcontext) -> {
        ...
        })))).then(net.minecraft.commands.CommandDispatcher.literal("function").then(net.minecraft.commands.CommandDispatcher.argument("name", ArgumentTag.functions()).suggests(CommandFunction.SUGGEST_FUNCTION).fork(commandnode, new CommandExecute.d(flag))));
    ...
    public static <T extends ExecutionCommandSource<T>> void scheduleFunctionConditionsAndTest(T t0, List<T> list, Function<T, T> function, IntPredicate intpredicate, ContextChain<T> contextchain, @Nullable NBTTagCompound nbttagcompound, ExecutionControl<T> executioncontrol, CommandExecute.a<T, Collection<net.minecraft.commands.functions.CommandFunction<T>>> commandexecute_a, ChainModifiers chainmodifiers) {
        ...
        if (i != 0) {
            ...
            try {
                ...
                while (iterator.hasNext()) {
                    net.minecraft.commands.functions.CommandFunction net_minecraft_commands_functions_commandfunction = (net.minecraft.commands.functions.CommandFunction) iterator.next();

                    try {
                        arraylist1.add(net_minecraft_commands_functions_commandfunction.instantiate(nbttagcompound, t0.dispatcher(), t0));
            ...
            executioncontrol.queueNext(new BuildContexts.a<>(s, contextchain1, chainmodifiers, t0, arraylist));
        }
    }
