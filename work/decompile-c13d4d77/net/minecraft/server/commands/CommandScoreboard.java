...
public class CommandScoreboard {
    ...
    public static void register(CommandDispatcher<CommandListenerWrapper> commanddispatcher) {
        ...
        })))).then(addNumberFormats(net.minecraft.commands.CommandDispatcher.literal("numberformat"), (commandcontext, numberformat) -> {
        ...
        }))))).then(((LiteralArgumentBuilder) net.minecraft.commands.CommandDispatcher.literal("display").then(net.minecraft.commands.CommandDispatcher.literal("name").then(net.minecraft.commands.CommandDispatcher.argument("targets", ArgumentScoreholder.scoreHolders()).suggests(ArgumentScoreholder.SUGGEST_SCORE_HOLDERS).then(((RequiredArgumentBuilder) net.minecraft.commands.CommandDispatcher.argument("objective", ArgumentScoreboardObjective.objective()).then(net.minecraft.commands.CommandDispatcher.argument("name", ArgumentChatComponent.textComponent()).executes((commandcontext) -> {
        ...
        }))))).then(net.minecraft.commands.CommandDispatcher.literal("numberformat").then(net.minecraft.commands.CommandDispatcher.argument("targets", ArgumentScoreholder.scoreHolders()).suggests(ArgumentScoreholder.SUGGEST_SCORE_HOLDERS).then(addNumberFormats(net.minecraft.commands.CommandDispatcher.argument("objective", ArgumentScoreboardObjective.objective()), (commandcontext, numberformat) -> {
    ...
    private static ArgumentBuilder<CommandListenerWrapper, ?> addNumberFormats(ArgumentBuilder<CommandListenerWrapper, ?> argumentbuilder, CommandScoreboard.a commandscoreboard_a) {
        ...
        })).then(net.minecraft.commands.CommandDispatcher.literal("fixed").then(net.minecraft.commands.CommandDispatcher.argument("contents", ArgumentChatComponent.textComponent()).executes((commandcontext) -> {
        ...
        }))).then(net.minecraft.commands.CommandDispatcher.literal("styled").then(net.minecraft.commands.CommandDispatcher.argument("style", StyleArgument.style()).executes((commandcontext) -> {
