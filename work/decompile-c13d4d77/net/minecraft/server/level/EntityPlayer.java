...
public class EntityPlayer extends EntityHuman {
    ...
    public void sendServerStatus(ServerPing serverping) {
        this.connection.send(new ClientboundServerDataPacket(serverping.description(), serverping.favicon().map(ServerPing.a::iconBytes), serverping.enforcesSecureChat()));
    }
        ...
        if (!super.startRiding(entity, flag)) {
            ...
            if (entity instanceof EntityLiving) {
                ...
                while (iterator.hasNext()) {
                    ...
                    this.connection.send(new PacketPlayOutEntityEffect(entity.getId(), mobeffect));
                }
            }
