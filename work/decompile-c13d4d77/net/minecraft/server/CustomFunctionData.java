...
public class CustomFunctionData {
    ...
    public void execute(CommandFunction<CommandListenerWrapper> commandfunction, CommandListenerWrapper commandlistenerwrapper) {
        ...
        try {
            InstantiatedFunction<CommandListenerWrapper> instantiatedfunction = commandfunction.instantiate((NBTTagCompound) null, this.getDispatcher(), commandlistenerwrapper);
