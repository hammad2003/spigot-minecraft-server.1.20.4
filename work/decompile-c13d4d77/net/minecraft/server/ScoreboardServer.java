...
public class ScoreboardServer extends Scoreboard {
    ...
    public List<Packet<?>> getStartTrackingPackets(ScoreboardObjective scoreboardobjective) {
        ...
        while (iterator.hasNext()) {
            ...
            list.add(new PacketPlayOutScoreboardScore(playerscoreentry.owner(), scoreboardobjective.getName(), playerscoreentry.value(), playerscoreentry.display(), playerscoreentry.numberFormatOverride()));
        }
    ...
    private PersistentScoreboard createData(NBTTagCompound nbttagcompound) {
