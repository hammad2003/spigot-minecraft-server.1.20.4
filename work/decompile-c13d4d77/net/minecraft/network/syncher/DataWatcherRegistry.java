...
public class DataWatcherRegistry {
    ...
    public static final DataWatcherSerializer<IChatBaseComponent> COMPONENT = DataWatcherSerializer.simple(PacketDataSerializer::writeComponent, PacketDataSerializer::readComponentTrusted);
    public static final DataWatcherSerializer<Optional<IChatBaseComponent>> OPTIONAL_COMPONENT = DataWatcherSerializer.optional(PacketDataSerializer::writeComponent, PacketDataSerializer::readComponentTrusted);
    ...
    public static final DataWatcherSerializer<Optional<IBlockData>> OPTIONAL_BLOCK_STATE = new DataWatcherSerializer.a<Optional<IBlockData>>() {
    ...
    public static final DataWatcherSerializer<ParticleParam> PARTICLE = new DataWatcherSerializer.a<ParticleParam>() {
        ...
        public ParticleParam read(PacketDataSerializer packetdataserializer) {
            return this.readParticle(packetdataserializer, (Particle) packetdataserializer.readById((Registry) BuiltInRegistries.PARTICLE_TYPE));
        }
    ...
    public static final DataWatcherSerializer<VillagerData> VILLAGER_DATA = new DataWatcherSerializer.a<VillagerData>() {
        ...
        public VillagerData read(PacketDataSerializer packetdataserializer) {
            return new VillagerData((VillagerType) packetdataserializer.readById((Registry) BuiltInRegistries.VILLAGER_TYPE), (VillagerProfession) packetdataserializer.readById((Registry) BuiltInRegistries.VILLAGER_PROFESSION), packetdataserializer.readVarInt());
        }
    };
    ...
    public static final DataWatcherSerializer<org.joml.Vector3f> VECTOR3 = DataWatcherSerializer.simple(PacketDataSerializer::writeVector3f, PacketDataSerializer::readVector3f);
    public static final DataWatcherSerializer<Quaternionf> QUATERNION = DataWatcherSerializer.simple(PacketDataSerializer::writeQuaternion, PacketDataSerializer::readQuaternion);
