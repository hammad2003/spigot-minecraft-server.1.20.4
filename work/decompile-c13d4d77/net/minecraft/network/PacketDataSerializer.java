...
public class PacketDataSerializer extends ByteBuf {
    ...
    public <T> T readWithCodec(DynamicOps<NBTBase> dynamicops, Codec<T> codec, NBTReadLimiter nbtreadlimiter) {
        ...
        return SystemUtils.getOrThrow(codec.parse(dynamicops, nbtbase), (s) -> {
    ...
    public IChatBaseComponent readComponent() {
        return (IChatBaseComponent) this.readWithCodec(DynamicOpsNBT.INSTANCE, ComponentSerialization.CODEC, NBTReadLimiter.create(2097152L));
    }

    public IChatBaseComponent readComponentTrusted() {
        return (IChatBaseComponent) this.readWithCodecTrusted(DynamicOpsNBT.INSTANCE, ComponentSerialization.CODEC);
    }

    public PacketDataSerializer writeComponent(IChatBaseComponent ichatbasecomponent) {
        return this.writeWithCodec(DynamicOpsNBT.INSTANCE, ComponentSerialization.CODEC, ichatbasecomponent);
    }
    ...
    public NBTTagCompound readNbt() {
        NBTBase nbtbase = this.readNbt(NBTReadLimiter.create(2097152L));
    ...
    public NBTBase readNbt(NBTReadLimiter nbtreadlimiter) {
        try {
            NBTBase nbtbase = NBTCompressedStreamTools.readAnyTag(new ByteBufInputStream(this), nbtreadlimiter);
    ...
    public ItemStack readItem() {
        if (!this.readBoolean()) {
            ...
            Item item = (Item) this.readById((Registry) BuiltInRegistries.ITEM);
    ...
    public Property readProperty() {
        ...
        String s2 = (String) this.readNullable(PacketDataSerializer::readUtf);
    ...
    public void writeProperty(Property property) {
        ...
        this.writeNullable(property.signature(), PacketDataSerializer::writeUtf);
    }
