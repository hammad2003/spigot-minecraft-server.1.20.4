...
public class ChatModifier {
    ...
    public static class ChatModifierSerializer {
        ...
        public static final MapCodec<ChatModifier> MAP_CODEC = RecordCodecBuilder.mapCodec((instance) -> {
            return instance.group(ExtraCodecs.strictOptionalField(ChatHexColor.CODEC, "color").forGetter((chatmodifier) -> {
                return Optional.ofNullable(chatmodifier.color);
            }), ExtraCodecs.strictOptionalField(Codec.BOOL, "bold").forGetter((chatmodifier) -> {
                return Optional.ofNullable(chatmodifier.bold);
            }), ExtraCodecs.strictOptionalField(Codec.BOOL, "italic").forGetter((chatmodifier) -> {
                return Optional.ofNullable(chatmodifier.italic);
            }), ExtraCodecs.strictOptionalField(Codec.BOOL, "underlined").forGetter((chatmodifier) -> {
                return Optional.ofNullable(chatmodifier.underlined);
            }), ExtraCodecs.strictOptionalField(Codec.BOOL, "strikethrough").forGetter((chatmodifier) -> {
                return Optional.ofNullable(chatmodifier.strikethrough);
            }), ExtraCodecs.strictOptionalField(Codec.BOOL, "obfuscated").forGetter((chatmodifier) -> {
                return Optional.ofNullable(chatmodifier.obfuscated);
            }), ExtraCodecs.strictOptionalField(ChatClickable.CODEC, "clickEvent").forGetter((chatmodifier) -> {
                return Optional.ofNullable(chatmodifier.clickEvent);
            }), ExtraCodecs.strictOptionalField(ChatHoverable.CODEC, "hoverEvent").forGetter((chatmodifier) -> {
                return Optional.ofNullable(chatmodifier.hoverEvent);
            }), ExtraCodecs.strictOptionalField(Codec.STRING, "insertion").forGetter((chatmodifier) -> {
                return Optional.ofNullable(chatmodifier.insertion);
            }), ExtraCodecs.strictOptionalField(MinecraftKey.CODEC, "font").forGetter((chatmodifier) -> {
