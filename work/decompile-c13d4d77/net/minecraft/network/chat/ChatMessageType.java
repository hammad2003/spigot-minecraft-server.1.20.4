...
public record ChatMessageType(ChatDecoration chat, ChatDecoration narration) {
    ...
    public static void bootstrap(BootstapContext<ChatMessageType> bootstapcontext) {
        bootstapcontext.register(ChatMessageType.CHAT, new ChatMessageType(ChatMessageType.DEFAULT_CHAT_DECORATION, ChatDecoration.withSender("chat.type.text.narrate")));
        bootstapcontext.register(ChatMessageType.SAY_COMMAND, new ChatMessageType(ChatDecoration.withSender("chat.type.announcement"), ChatDecoration.withSender("chat.type.text.narrate")));
        bootstapcontext.register(ChatMessageType.MSG_COMMAND_INCOMING, new ChatMessageType(ChatDecoration.incomingDirectMessage("commands.message.display.incoming"), ChatDecoration.withSender("chat.type.text.narrate")));
        bootstapcontext.register(ChatMessageType.MSG_COMMAND_OUTGOING, new ChatMessageType(ChatDecoration.outgoingDirectMessage("commands.message.display.outgoing"), ChatDecoration.withSender("chat.type.text.narrate")));
    ...
    public static record b(int chatType, IChatBaseComponent name, @Nullable IChatBaseComponent targetName) {
        ...
        public b(PacketDataSerializer packetdataserializer) {
            this(packetdataserializer.readVarInt(), packetdataserializer.readComponentTrusted(), (IChatBaseComponent) packetdataserializer.readNullable(PacketDataSerializer::readComponentTrusted));
        }
