...
public class ClientboundPlayerInfoUpdatePacket implements Packet<PacketListenerPlayOut> {
    ...
    public static enum a {
        ...
        ADD_PLAYER((clientboundplayerinfoupdatepacket_c, packetdataserializer) -> {
            ...
            packetdataserializer.writeUtf(gameprofile.getName(), 16);
            packetdataserializer.writeGameProfileProperties(gameprofile.getProperties());
            ...
            clientboundplayerinfoupdatepacket_c.displayName = (IChatBaseComponent) packetdataserializer.readNullable(PacketDataSerializer::readComponentTrusted);
        }, (packetdataserializer, clientboundplayerinfoupdatepacket_b) -> {
